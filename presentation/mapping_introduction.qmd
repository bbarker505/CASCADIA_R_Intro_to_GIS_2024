...
-   [`Using RStudio for Geospatial Analysis`](https://lagerratrobe.quarto.pub/rstudio-for-practical-geospatial-analysis/#/title-slide)
-   [`Thoughts on Parallelization in R`](https://lagerratrobe.quarto.pub/thoughts-on-paralleliaztion-in-r/#/title-slide)
-   [`Using GDAL for Data Processing and Analysis`](https://upload.osgeo.org/gdal/presentations/OpenSource_Weds_Andre_CUGOS.pdf)
:::
:::
